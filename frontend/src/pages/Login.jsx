            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <svg className="absolute bottom-0 left-0 w-full h-64" viewBox="0 0 1200 300" preserveAspectRatio="none">
                    ...
                    <path
                        ...
                        d="M0,60 C300,160 600,-30 900,60 C1050,90 1150,60 1200,60 L1200,300 L0,300 Z"
                    >
                        <animate
                            attributeName="d"
                            dur="5s"
                            ...
                            values="
                            M0,60 C300,160 600,-30 900,60 C1050,90 1150,60 1200,60 L1200,300 L0,300 Z;
                    ...
                    <path
                        ...
                        d="M0,120 C250,170 550,40 850,120 C1000,145 1100,120 1200,120 L1200,300 L0,300 Z"
                    >
                        <animate
                            attributeName="d"
                            dur="10s"
                            repeatCount="indefinite"
                            values="
                            M0,120 C250,170 550,-40 850,120 C1000,145 1100,120 1200,120 L1200,300 L0,300 Z;
